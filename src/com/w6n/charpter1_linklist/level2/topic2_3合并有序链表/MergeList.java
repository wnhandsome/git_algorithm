package com.w6n.charpter1_linklist.level2.topic2_3合并有序链表;
...
public class MergeList {
    public static void main(String[] args) {
        ...
        switch (testMethod) {
            ...
            case 4://测试K个链表合并
                ...
                break;
            case 5:
                d = mergeTwoListsByWn(nodeA,nodeB);
                break;
            case 6://测试K个链表合并
                d = mergeKListsByWn(array);
                break;
            case 7:
                d = rotateRight(nodeA,1);
                break;
        }
    ...
    public static ListNode rotateRight(ListNode head, int k) {
        ...
        ListNode node1 = getKthFromEnd(head,count);
        ListNode node2 = getKthFromEnd(head,count+1);
        node2.next = null;
        ListNode res = node1;
    ...
    public static ListNode mergeTwoListsByWn(ListNode list1, ListNode list2){
     ...
     * @return
     */
    public static ListNode mergeKListsByWn(ListNode[] lists) {
        ListNode res = null;
        for (ListNode list : lists) {
            res = mergeTwoListsByWn(res, list);
        }
        return res;
    }
